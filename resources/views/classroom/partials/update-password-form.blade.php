        ...
        <div class="col-xl-6 order-xl-0">
            <form action="{{ route('users.update.password', ['user' => $user->id]) }}" method="POST">
                ...
                {{-- <div class="mb-4">
                    ...
                    <input type="password" class="form-control form-control-sm" id="update_password_current_password"
                        name="current_password">
                    <x-input-error-field :messages="$errors->updatePassword->get('current_password')" class="mt-2" />
                </div> --}}
                <div class="row mb-4">
                    <div class="col-12">
                        <label class="form-label" for="update_password_password">New Password</label>
                        <input type="password" class="form-control form-control-sm" id="update_password_password" name="password">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <label class="form-label" for="update_password_password_confirmation">Confirm New
                            Password</label>
                        <input type="password" class="form-control form-control-sm" id="update_password_password_confirmation"
