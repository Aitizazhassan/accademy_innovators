<x-app-layout>
    ...
    <div class="bg-body-light">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Country
                @can('user.create')
                    <a href="{{ route('country.create') }}" class="btn btn-primary ms-3"><i class="fa fa-plus"></i> Create Country</a>
                @endcan
            </h1>
            <x-breadcrumbs />
        </div>
        ...
        $(document).ready(function() {
            ...
            $('#users-table').on('click', '.delete-user', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('country.destroy', ':id') }}".replace(':id', userId),
                            type: 'DELETE',
                            headers: {
