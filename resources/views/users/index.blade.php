<x-app-layout>
    ...
    <div class="bg-body-light">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Users
                @can('user.create')
                    <a href="{{ route('users.create') }}" class="btn btn-primary ms-3"><i class="fa fa-plus"></i> Create User</a>
                @endcan
            </h1>
            <x-breadcrumbs />
        </div>
                ...
                <table class="table table-bordered table-striped table-vcenter table-sm" id="users-table">
                    <thead>
                        <tr>
                            ...
                            <th>Name</th>
                            <th class="d-sm-table-cell" style="width: 30%;">Email</th>
                            <th class="d-sm-table-cell" style="width: 15%;">Role</th>
                            <th class="d-sm-table-cell" style="width: 15%;">Access</th>
                            <th>Date</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
